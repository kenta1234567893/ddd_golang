...
func (iq *InvoiceQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (iq *InvoiceQuery) FirstIDX(ctx context.Context) uint64 {
...
func (iq *InvoiceQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (iq *InvoiceQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (iq *InvoiceQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (iq *InvoiceQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := iq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (iq *InvoiceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Invoice, error) {
	...
	if iq.withCompany != nil || iq.withCustomer != nil {
		withFKs = true
	}
	if withFKs {
...
func (iq *InvoiceQuery) loadCompany(ctx context.Context, query *CompanyQuery, nodes []*Invoice, init func(*Invoice), assign func(*Invoice, *Company)) error {
	...
	nodeids := make(map[uint64][]*Invoice)
	for i := range nodes {
...
func (iq *InvoiceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(invoice.Table, invoice.Columns, sqlgraph.NewFieldSpec(invoice.FieldID, field.TypeUint64))
	_spec.From = iq.sql
