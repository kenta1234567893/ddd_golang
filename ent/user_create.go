...
func (uc *UserCreate) SetEmail(f float64) *UserCreate {
	uc.mutation.SetEmail(f)
	return uc
}

// SetPassword sets the "password" field.
func (uc *UserCreate) SetPassword(f float64) *UserCreate {
	uc.mutation.SetPassword(f)
	return uc
}
...
func (uc *UserCreate) SetCompanyID(id uint64) *UserCreate {
